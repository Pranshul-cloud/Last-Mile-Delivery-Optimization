...
- [`3.1_dashboard/`](https://github.com/Pranshul-cloud/Last-Mile-Delivery-Optimization/blob/main/03_executive_report/3.1_last_mile_dashboard.pbix): Power BI files used to build key delivery and performance visuals_(Not previewable on GitHub — available for download and offline viewing in Power BI Desktop)_
